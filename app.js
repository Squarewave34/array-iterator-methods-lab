...
sortedByBirthYear = inventors.sort((year_1, year_2)=>{
  return year_1.year - year_2.year
})

// used https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array/sort for reference
...
// used https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/String/split for reference
